        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DirectAgent = table.Column<string>(nullable: true),
                    EffectiveDate = table.Column<DateTime>(nullable: false),
                    LeadAgent = table.Column<string>(nullable: true),
                    MemberQuantity = table.Column<int>(nullable: false),
                    Metal = table.Column<string>(nullable: true),
                    Premium = table.Column<double>(nullable: false),
                    ProductNameId = table.Column<int>(nullable: true),
                    ReferringAgent = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sales_InsuranceCompanies_CarrierId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Sales_PlanTypes_ProductNameId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepositedMoney = table.Column<int>(nullable: false),
                    PlanTypeId = table.Column<int>(nullable: true),
